...
<book version="5.0" xmlns="http://docbook.org/ns/docbook" xmlns:xi="http://www.w3.org/2001/XInclude">
    ...
    <#assign central_footer_text = 'KMA/KMP' />
...
<#--                </#if>-->
        ...
        <subtitle>
            <para role="align-right">
                <para role="HEAD-3">Document M-<#if _subject.documentType=="MIXTURE">MP<#elseif _subject.documentType=="SUBSTANCE">MA</#if></para>
                <@com.emptyLine/>
    ...
    <#if _subject.documentType=="MIXTURE">
        ...
        <#--		</chapter>-->
<#--        <chapter label="CP 7">-->
<#--            <title role="HEAD-1">Effects on human health</title>-->
<#--            <#include "05_tox_micro.ftl" encoding="UTF-8" />-->
<#--        </chapter>-->
        <chapter label="MP 10">
            <title role="HEAD-1">Effects on non-target organisms</title>
