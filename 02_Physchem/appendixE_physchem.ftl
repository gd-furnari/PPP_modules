<!-- Macros and functions for EU PPP reports, including appendix E format (subset for physchem only)-->
...
<#macro appendixEconclusion _subject study>
	<#compress>
		...
		<#if study.ApplicantSummaryAndConclusion.ExecutiveSummary?has_content>
			...
			<para><@com.richText study.ApplicantSummaryAndConclusion.ExecutiveSummary/></para>
		</#if>

		<#if study.ApplicantSummaryAndConclusion.Conclusions?has_content>
			<para><emphasis role="bold">Conclusion:</emphasis></para>
			<para><@com.text study.ApplicantSummaryAndConclusion.Conclusions/></para>
		</#if>
...
<#macro appendixEmethods _subject study>
	...
	<!-- Specific methods -->
	<#if study.documentSubType=="ToxicityToOtherAboveGroundOrganisms">
		<@keyBioPropMicro.methods_toxicityAboveGroundOrg study/>
	<#else>
...
<#macro appendixEresults _subject study>
	<#compress>
		...
		<#elseif study.documentSubType=="ToxicityToOtherAboveGroundOrganisms">
			<#--NOTE: this is for microorg-->
		...
		<#--2. Other information including tables (to include?)
...
<#--macro to filter studies based on context-->
...
<#function isRelevantAdequacyOfStudy study>
    ...
    <#return PurposeFlag?has_content />
<#--	&& !com.picklistValueMatchesPhrases(PurposeFlag, ["other information"]) />-->
</#function>
