...
<#--Documents M - Section 6 (Efficacy) for a mixture/product.-->
...
<#import "common_module_efficacy.ftl" as keyEfficacy>
...
<#assign docFullName="Efficacy data"/>
<#assign docName=""/>
...
<book version="5.0" xmlns="http://docbook.org/ns/docbook" xmlns:xi="http://www.w3.org/2001/XInclude">
    ...
    <chapter label="${docName} ${sectionNb}">
        ...
        <#include "06_efficacy.ftl" encoding="UTF-8" />
    </chapter>
