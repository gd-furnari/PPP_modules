...
<#--Documents M - Section 1 (Identity) for the active substance of a mixture/product.-->
...
<#if _subject.submissionType?has_content>
    <#if _subject.submissionType?matches(".*MICRO.*", "i")>
        ...
        <#assign docName="MA"/>
        <#assign docFullName="Identity of the micro-organism"/>
...
<#if !(errorMessage??)>
    <book version="5.0" xmlns="http://docbook.org/ns/docbook" xmlns:xi="http://www.w3.org/2001/XInclude">
        ...
        <#-- Annex for reference substances (uses composition and basic information common modules)-->
        <chapter label="Annex">
