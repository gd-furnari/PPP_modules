...
<#--Documents M - Section 3 (Further information) for the active substance of a mixture/product.-->
...
<#if _subject.submissionType?has_content>
    <#if _subject.submissionType?matches(".*MICRO.*", "i")>
        ...
        <#assign docName="MA"/>
        <#assign docFullName="Further information on the micro-organism"/>
    ...
    <#else>
        ...
        <#assign docName="CA"/>
        <#assign docFullName="Further information the active substance"/>
    </#if>
</#if>
