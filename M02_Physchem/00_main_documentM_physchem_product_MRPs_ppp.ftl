...
<#if _dossierHeader??>
    ...
    <#assign dossierName><@com.text _dossierHeader.name /></#assign>
</#if>
...
<#--        &lt;#&ndash; get just the active substance&ndash;&gt;-->
...
<#assign otherProds=iuclid.getSectionDocumentsForParentKey(_subject.documentKey, "FLEXIBLE_SUMMARY", "OtherRepresentativeProducts") />
<#assign allProds=[_subject]/>
<#list otherProds as otherProd>
    <#if otherProd.OtherRepresentativeProductS?has_content>
        <#list otherProd.OtherRepresentativeProductS as prodLink>
            <#assign prod=iuclid.getDocumentForKey(prodLink)/>
            <#if prod?has_content>
                <#assign allProds = com.addDocumentToSequenceAsUnique(prod, allProds)/>
            </#if>
        </#list>
    </#if>
</#list>
...
<book version="5.0" xmlns="http://docbook.org/ns/docbook" xmlns:xi="http://www.w3.org/2001/XInclude">
    ...
    <info>
        ...
        <title>
            ...
            <@com.emptyLine/>
            <#if (allProds?size>1) && _dossierHeader??>
                <ulink url="${dossierUrl}">Dossier <@com.text _dossierHeader.name/></ulink>
                <?linebreak?>(multiple representative products)
            <#else>
    ...
    <#list allProds as prod>
        <#global _subject=prod/>

        <#if (allProds?size>1)><part><title>Product: <@com.text prod.MixtureName/></title></#if>
        ...
        <#if (allProds?size>1)></part></#if>

    </#list>

    <#if (allProds?size>1)><part label="Annex"><title role="HEAD-1">Information on Test Materials</title></#if>
        <chapter label="Annex">
            <title role="HEAD-1">Information on Test Materials</title>
