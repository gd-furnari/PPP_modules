<#assign ecotoxContext = { "ToxicityToBirds_oral" : [{"path": "AdministrativeData.Endpoint", "val" : ["acute oral"], "qual" : "lk", "type" : "picklist"}],
                            ...
                            "ToxicityToSoilMacroorganismsExceptArthropods_noEarthworm" : [{"path": "MaterialsAndMethods.TestOrganisms.TestOrganismsSpecies",
                                                                                          "val" : ["Eisenia", "Aporrectodea", "Enchytraeus", "Lumbricus", "Cognettia"],
                                                                                            "qual" : "nl", "type" : "picklist"}],

                            "ToxicityToSoilMacroorganismsExceptArthropods_folsomiaAndHypoaspis" : [{"path": "MaterialsAndMethods.TestOrganisms.TestOrganismsSpecies",
                                                                                                      "val" : ["Folsomia candida","Hypoaspis aculeifer"],
                                                                                                        "qual" : "lk", "type" : "picklist"}],

                            "ToxicityToSoilMacroorganismsExceptArthropods_noSpecies" : [{"path": "MaterialsAndMethods.TestOrganisms.TestOrganismsSpecies",
                                                                                                        "val" : ["Folsomia candida","Hypoaspis aculeifer",
                                                                                                                "Eisenia", "Aporrectodea", "Enchytraeus", "Lumbricus", "Cognettia"],
                                                                                                        "qual" : "nl", "type" : "picklist"}],
    ...
    <#if _subject.documentType=="SUBSTANCE">
        ...
        <sect1>
            ...
            <sect2>
                ...
                <para>Study summaries for effects on terrestrial vertebrate wildlife are provided in <command  linkend="CA813">Section 8.1.3</command> above.</para>
        ...
        <sect1>
            ...
            <sect2>
                ...
                <sect3>
                    ...
                    <#-- It should be for Folsomia candida and Hypoaspis aculeifer but since there is no other section everything is included here-->
                    <@keyAppendixE.appendixEstudies _subject "ToxicityToSoilMacroorganismsExceptArthropods" ecotoxContext["ToxicityToSoilMacroorganismsExceptArthropods_noEarthworm"]
                    "toxicity to other soil meso- and macrofauna than earthworms"/>
                </sect3>
            </sect2>

            <#--NEW (not sure right approach)-->
            <sect2>
                <title role="HEAD-3">Bioconcentration in terrestrial animals</title>
                <#--    Where does bioaccumulation go?-->
    ...
    <#elseif _subject.documentType=="MIXTURE">
        ...
        <sect1>
            ...
            <sect2>
                ...
                <sect3>
                    <title role="HEAD-4">Acute oral toxicity</title>
                    <@keyAppendixE.appendixEstudies _subject "ToxicityToBirds" ecotoxContext["ToxicityToBirds_oral"]
                        "acute oral toxicity to birds"/>
                </sect3>
                <sect3>
                    <title role="HEAD-4">Higher tier data on birds</title>
                    <@keyAppendixE.appendixEstudies _subject "ToxicityToBirds" ecotoxContext["ToxicityToBirds_nonOral"]
                        "other toxicity to birds"/>
                </sect3>
            </sect2>
            ...
            <sect2>
                ...
                <para>Study summaries for effects on other terrestrial vertebrate wildlife are provided in <command  linkend="CP10122">Section 10.1.2.2</command> above.</para>
        ...
        <sect1>
            ...
            <sect2>
                ...
                <@keyAppendixE.appendixEstudies _subject=_subject
            ...
            <sect2>
                ...
                <@keyEcotox.ecotoxPPPsummary_merged _subject=_subject
                docSubTypes=["LongTermToxicityToFish_EU_PPP","LongTermToxicityToAquaticInvertebrates_EU_PPP"]/>

                <#-- NOTE: missing sediment dwelling orgs?-->
                <@keyAppendixE.appendixEstudies _subject=_subject docSubTypes=["LongTermToxToFish","LongTermToxicityToAquaInv"]
...
<#elseif workingContext=="MICRO">
    ...
    <sect1>
        ...
        <sect2>
            ...
            <@keyEcotox.ecotoxPPPsummary_merged _subject=_subject docSubTypes=["Short-termToxicityToFish_EU_PPP","LongTermToxicityToFish_EU_PPP"]/>
            <@keyAppendixE.appendixEstudies _subject=_subject docSubTypes=["ShortTermToxicityToFish","LongTermToxToFish"] name="toxicity to fish"/>
        </sect2>

        <sect2>
            <title role="HEAD-3">Effects on freshwater invertebrates</title>
            <@keyEcotox.ecotoxPPPsummary_merged _subject=_subject
                docSubTypes=["ShortTermToxicityAquaInvert_EU_PPP","LongTermToxicityToAquaticInvertebrates_EU_PPP"]/>
            <@keyAppendixE.appendixEstudies _subject=_subject docSubTypes=["ShortTermToxicityToAquaInv","LongTermToxicityToAquaInv"]
